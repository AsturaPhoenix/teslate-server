...
public class Session {
  private static long SCREEN_REFRACTORY = 5000,
      STABLE_UPDATE = 2000,
      STABLE_TIME = 2000;

  private static final long COMMAND_TIMEOUT = 10000;

  private static final int DIFF_COLOR_THRESH = 128,
      DIFF_RES = 5;

  private static final float DIFF_THRESH = .22f;
  ...
  private final Semaphore frameSemaphore = new Semaphore(0),
  ...
  public void update(int x, int y, byte[] bytes) {
    ...
    final int cwidth = x + patch.getWidth(),
